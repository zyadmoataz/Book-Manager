...
import { ArrowLeft, BookOpen, Calendar, User, Tag, Star } from "lucide-react";
    ...
    <PageLayout>
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center rounded-2xl border border-slate-200 bg-white p-12 text-center shadow-sm">
          ...
          <p className="mt-2 text-slate-500">The book you're looking for doesn't exist or has been removed.</p>
        </div>
      ) : (
        <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-xl shadow-slate-200/40">
          <div className="grid md:grid-cols-2 lg:grid-cols-5">
            ...
            <div className="relative bg-slate-100 lg:col-span-2">
              <img 
                src={data.cover || "https://images.unsplash.com/photo-1544947950-fa07a98d237f?q=80&w=800&auto=format&fit=crop"} 
                alt={data.title}
            ...
            <div className="flex flex-col p-8 md:p-10 lg:col-span-3">
              <div className="mb-4 flex items-center gap-3">
                ...
                <span className={`inline-flex items-center rounded-full px-3 py-1 text-sm font-semibold ${data.read ? 'bg-emerald-50 text-emerald-700 ring-1 ring-inset ring-emerald-600/20' : 'bg-amber-50 text-amber-700 ring-1 ring-inset ring-amber-600/20'}`}>
